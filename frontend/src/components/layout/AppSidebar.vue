...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/chat-plaza', label: t('nav.chatPlaza'), icon: ChatIcon, hideInSimpleMode: true },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/abuse', label: t('nav.abuseDetection'), icon: ShieldIcon, hideInSimpleMode: true },
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/admin/orders/refund-assessment', label: t('nav.refundAssessment'), icon: ChartIcon },
      ],
    },
