export default {
  ...
  payment: {
    ...
    discountHintTitle: '充值折扣生效中',
    discountHintBody: '当前充值可额外获得 {rate}% 赠金，剩余可参与额度 ${remaining}',
    discountHintExpiry: '有效期至 {date}',
    refundReason: '退款原因',
  ...
  refundAssessment: {
    emailPlaceholder: '输入用户注册邮箱',
    search: '查询',
    searchFailed: '查询失败',
    userOverview: '用户概览',
    email: '邮箱',
    currentPool: '当前充值池余额',
    apiUsedRecharge: 'API 消耗 (充值池)',
    giftUsed: '赠金消耗',
    refundDeducted: '退费扣减累计',
    effectiveUsed: '有效总消耗 (API+退费)',
    consumptionSummary: '消耗汇总',
    totalPaidCredited: '付费到账总额',
    totalFreeCredited: '免费到账总额',
    paidConsumedBalance: '付费已消耗 (余额)',
    freeConsumedBalance: '免费已消耗 (余额)',
    paidConsumedMoney: '付费已消耗 (实付)',
    refundSuggestion: '退费建议',
    totalPaidByUser: '用户总实付',
    paidConsumed: '已消耗实付',
    suggestedRefund: '建议可退',
    refundable: '可退',
    statusRefunded: '已退',
    statusPartial: '部分退',
    deducted: '扣减',
    fifoDetail: 'FIFO 分摊明细',
    colSource: '来源',
    colCreditedAt: '入账时间',
    colAmount: '到账余额',
    colPayAmount: '实付金额',
    colRatio: '倍率',
    colConsumed: '已消耗余额',
    colConsumedMoney: '已消耗实付',
    colRemaining: '剩余余额',
    colRefundStatus: '退费状态',
    colNote: '备注',
    free: '免费',
    noRecords: '该用户无入账记录',
    sourcePayment: '支付订单',
  ...
  gifts: {
    ...
    statusExhausted: '已耗尽',
    sourceKeybind: '绑定赠金',
    sourceReferralInvitee: '邀请注册奖励',
    sourceReferralInviter: '邀请达标奖励',
