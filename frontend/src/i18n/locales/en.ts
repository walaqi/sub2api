export default {
  ...
  nav: {
    ...
    paymentPlans: 'Plans',
    refundAssessment: 'Refund Assessment',
  ...
  auth: {
    ...
    emailSuffixAllowedHint: 'Please register with one of these email domains: {suffixes}',
  ...
  usage: {
    ...
    original: 'Original',
    billed: 'Billed',
    giftDeducted: 'Gift used',
    giftCostLabel: 'Gift',
    rechargeDeducted: 'Recharge used',
    rechargeCostLabel: 'Recharge',
  ...
  affiliate: {
    ...
    superReferral: {
      ...
      rechargeNeededAny: 'Complete one recharge to become a Super Referrer',
  ...
  redeem: {
    ...
    balanceAddedGift: 'Gift Credit Received',
  ...
  profile: {
    ...
    giftExpiringAt: 'expiring at {date}',
    giftModePriority: 'priority',
    giftModeRatio: 'ratio',
  ...
  admin: {
    ...
    users: {
      ...
      giftStatusRevoked: 'Revoked',
      giftStatusExpired: 'Expired',
      giftStatusExhausted: 'Exhausted',
    ...
    accounts: {
      ...
      bulkEdit: {
        ...
        mixedPlatformBlocked: 'Selected accounts span multiple platforms ({platforms}) and cannot be bulk edited. Please select accounts from a single platform and try again.'
      },
      ...
      modelMappingJsonInvalid: 'Invalid JSON format',
      modelMappingJsonNotObject: 'Must be a JSON object',
      modelMappingJsonValueNotString: 'All values must be strings. Key "{key}" has a non-string value.',
      modelMappingJsonKeyWildcard: 'Key "{key}": wildcard * can only be at the end',
      modelMappingJsonValueWildcard: 'Key "{key}": target model cannot contain wildcard *',
    ...
    announcements: {
      ...
      form: {
        ...
        referralInviterRewardBlocked: 'Has pending reward (quota exhausted)'
      },
      operators: {
        gt: '>',
        gte: '≥',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          referralRewardEnabled: 'Enable Super Referral Reward',
          referralRewardEnabledHint: 'When on, new invitees receive a signup bonus and inviters earn a reward once invitee spending reaches the threshold.',
          referralInviteeAmount: 'Invitee Signup Bonus',
          referralInviteeAmountHint: 'Amount (USD) credited to new users immediately upon registering via an invite link.',
          ...
          referralEligibilityGrantMode: 'Eligibility Grant Mode',
          referralEligibilityGrantModeHint: 'Controls when an inviter becomes eligible for super referral benefits. Changes affect future binds and lazy tracker creation.',
          referralEligibilityGrantModeBindKeyClaim: 'After claiming a key',
          referralEligibilityGrantModeRecharge: 'After recharge',
          referralEligibilityRechargeMinAmount: 'Minimum Cumulative Recharge',
          referralEligibilityRechargeMinAmountHint: 'In after-recharge mode, the inviter total recharged amount must reach this value to unlock eligibility, regardless of any key claim. 0 means any recharge qualifies.',
          ...
          referralInviterGiftMode: 'Inviter Reward Deduction Mode',
          referralInviterGiftModeHint: 'Controls how the inviter reward is consumed after it is granted. Invitee signup bonuses always use priority mode.',
          referralInviterGiftModePriority: 'Priority',
          referralInviterGiftModeRatio: 'Ratio',
          referralInviterGiftRatio: 'Inviter Reward Ratio',
          referralInviterGiftRatioHint: 'Ratio mode only. For each $1 of recharge balance consumed, this amount of reward balance is consumed.',
          referralInviterExpiryDays: 'Inviter Reward Expiry',
          referralInviterExpiryDaysHint: 'Number of days before the inviter reward expires (from grant time).',
          referralDiscountValidDays: 'Inherited Discount Validity',
          referralDiscountValidDaysHint: 'Number of days the invitee inherits the inviter recharge discount.',
          referralRewardQuotaEnabled: 'Limit inviter reward grant count',
          referralRewardQuotaEnabledHint: 'When enabled, inviters earn "grant chances" by recharging; once exhausted, invitee thresholds no longer pay out until the inviter tops up, at which point pending rewards are granted immediately. When disabled, grants are unlimited (current behavior).',
          referralRewardQuotaRechargeStep: 'Recharge per batch',
          referralRewardQuotaRechargeStepHint: 'Each time the inviter recharges this amount, they earn one batch of grant chances (leftover carries across recharges).',
          referralRewardQuotaPerBatch: 'Chances per batch',
          referralRewardQuotaPerBatchHint: 'Number of inviter-reward grant chances earned per completed recharge batch.',
      ...
      gatewayForwarding: {
        ...
        openaiCodexUserAgentPlaceholder: 'codex-tui/0.144.4 (Ubuntu 22.4.0; x86_64) xterm-256color (codex-tui; 0.144.4)',
      ...
      webSearchEmulation: {
        ...
        apiKeyConfigured: 'Configured',
        endpoint: 'API URL',
        endpointHint: 'Leave empty to use the official endpoint',
        endpointInvalid: 'Endpoint must be a valid http(s) URL',
        showApiKey: 'Show',
        hideApiKey: 'Hide',
        copyApiKey: 'Copy',
        copied: 'Copied',
        ...
        healthChecking: 'Pending',
        healthStatusCode: 'Status',
        healthLatency: 'Latency',
        healthCheckedAt: 'Checked at',
        healthError: 'Error',
        healthOnlyCustom: 'Health checks run only for custom API endpoints',
      },
      site: {
        title: 'Site Settings',
      ...
      payment: {
        ...
        easypayCustomType: 'Custom',
        easypayCustomTypeHint: 'Aggregate any EasyPay sub-method by sending a free-form type string (e.g. epay / qqpay / usdt). Only redirect/popup is supported; no in-page QR code.',
        easypayCustomTypeLabel: 'Channel type',
        easypayCustomLabel: 'Button label',
        easypayCustomIconUrl: 'Button icon URL',
        easypayCustomMultiplier: 'Balance multiplier override',
        easypayCustomPrefix: 'Product name prefix',
        easypayCustomSuffix: 'Product name suffix',
        easypayCustomTypeRequired: 'Custom channel type is required',
        easypayCustomTypeInvalid: 'Type may only contain letters, digits, and underscores',
        easypayCustomTypeReserved: 'Type cannot reuse a reserved value (alipay / wxpay)',
        easypayCustomLabelRequired: 'Button label is required',
        easypayCustomIconUrlRequired: 'Icon URL is required',
        easypayCustomIconUrlInvalid: 'Icon URL must start with http:// or https://',
        easypayCustomMultiplierInvalid: 'Multiplier must be a positive number',
      },
      balanceNotify: {
        title: 'Balance Low Notification',
  ...
  payment: {
    ...
    discountHintTitle: 'Recharge discount active',
    discountHintBody: 'Top up now to receive an extra {rate}% bonus. Remaining eligible amount: ${remaining}',
    discountHintExpiry: 'Valid until {date}',
  ...
  refundAssessment: {
    emailPlaceholder: 'Enter user registration email',
    search: 'Search',
    searchFailed: 'Search failed',
    userOverview: 'User Overview',
    email: 'Email',
    currentPool: 'Current Recharge Pool',
    apiUsedRecharge: 'API Usage (Recharge Pool)',
    giftUsed: 'Gift Usage',
    refundDeducted: 'Total Refund Deducted',
    effectiveUsed: 'Effective Total (API + Refund)',
    consumptionSummary: 'Consumption Summary',
    totalPaidCredited: 'Paid Credited Total',
    totalFreeCredited: 'Free Credited Total',
    paidConsumedBalance: 'Paid Consumed (Balance)',
    freeConsumedBalance: 'Free Consumed (Balance)',
    paidConsumedMoney: 'Paid Consumed (Money)',
    refundSuggestion: 'Refund Suggestion',
    totalPaidByUser: 'Total Paid by User',
    paidConsumed: 'Paid Consumed',
    suggestedRefund: 'Suggested Refund',
    refundable: 'Refundable',
    statusRefunded: 'Refunded',
    statusPartial: 'Partial',
    deducted: 'Deducted',
    fifoDetail: 'FIFO Allocation Details',
    colSource: 'Source',
    colCreditedAt: 'Credited At',
    colAmount: 'Credited Balance',
    colPayAmount: 'Paid Amount',
    colRatio: 'Ratio',
    colConsumed: 'Consumed Balance',
    colConsumedMoney: 'Consumed Money',
    colRemaining: 'Remaining',
    colRefundStatus: 'Refund Status',
    colNote: 'Note',
    free: 'Free',
    noRecords: 'No credit records found for this user',
    sourcePayment: 'Payment Order',
  ...
  gifts: {
    ...
    neverExpires: 'Never expires',
    remaining: 'Remaining',
    empty: 'No gift credits yet',
    modePriority: 'Priority',
    modeRatio: 'Ratio',
    statusExpired: 'Expired',
    statusExhausted: 'Exhausted',
    sourceKeybind: 'Key Binding',
    sourceReferralInvitee: 'Signup Reward',
