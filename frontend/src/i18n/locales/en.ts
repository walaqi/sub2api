export default {
  ...
  referral: {
    ...
    rule1: 'Invitees receive gift credit immediately upon registration (valid for 2 days)',
    rule2: 'When an invitee spends a cumulative $10, the inviter receives gift credit (valid for 30 days)',
