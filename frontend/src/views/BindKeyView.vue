...
const en: Copy = {
  ...
  pasteHint: 'Up to 200 keys per request. The first eligible key (unbound, >50% remaining quota) will be reserved for 5 minutes.',
...
const zh: Copy = {
  ...
  pastePlaceholder: 'sk-xxxxxxxxxxxxxxxxxxxx\nsk-yyyyyyyyyyyyyyyyyyyy',
  pasteHint: '单次最多 200 行。系统将自动从上到下选择第一个符合条件的 Key并预留 5 分钟。',
  bindButton: '预留并绑定',
  reserving: '预留中…',
  pendingTitle: '绑定预留中',
