		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"referral_invitee_amount": 10.0,
					"referral_invitee_expiry_days": 2,
					"referral_inviter_amount": 10.0,
					"referral_inviter_expiry_days": 30,
					"referral_inviter_gift_mode": "priority",
					"referral_inviter_gift_ratio_recharge": 0.5,
					"referral_spend_threshold": 10.0,
					...
					"referral_inviter_reward_quota_recharge_step": 50.0,
...
func (r *stubUserRepo) GetEmailContactsByIDs(context.Context, []int64) (map[int64]service.UserEmailContact, error) {
	return nil, nil
}
