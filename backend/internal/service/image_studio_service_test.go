...
func TestImageStudioMintTicketVerifiesWithPublicKey(t *testing.T) {
	...
	svc, err := NewImageStudioService(newImageStudioConfig(pemKey), nil, nil)
	if err != nil {
...
func TestImageStudioDisabledReturnsError(t *testing.T) {
	...
	svc, err := NewImageStudioService(cfg, nil, nil)
	if err != nil {
...
func TestImageStudioEnabledWithBadPEMFails(t *testing.T) {
	...
	if _, err := NewImageStudioService(cfg, nil, nil); err == nil {
